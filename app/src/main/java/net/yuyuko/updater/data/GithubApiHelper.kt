...
import net.yuyuko.updater.data.retrofit.Content
import net.yuyuko.updater.data.retrofit.OTAJsonContent
import net.yuyuko.updater.data.retrofit.GithubApiService
