...
package net.yuyuko.updater.services
...
import net.yuyuko.updater.ui.MainActivity
...
class UpdateInstallerService : LifecycleService() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL_UPDATE = "net.yuyuko.updater.action.CANCEL_UPDATE"
        private const val ACTION_REBOOT = "net.yuyuko.updater.action.REBOOT"
        private const val ACTION_CANCEL_AUTO_REBOOT = "net.yuyuko.updater.action.CANCEL_AUTO_REBOOT"
